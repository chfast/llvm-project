...
; RUN: llc < %s -mtriple=x86_64-unknown -combiner-topological-sorting | FileCheck %s --check-prefixes=CHECK,TOPO-X64
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add128:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
; TOPO-X64-NEXT:    movq %rsi, %rdx
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: add128:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add128_rmw:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add128_rmw2:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rdi, (%rdx)
; TOPO-X64-NEXT:    adcq %rsi, 8(%rdx)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add256:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %r9, %rsi
; TOPO-X64-NEXT:    adcq {{[0-9]+}}(%rsp), %rdx
; TOPO-X64-NEXT:    adcq {{[0-9]+}}(%rsp), %rcx
; TOPO-X64-NEXT:    adcq {{[0-9]+}}(%rsp), %r8
; TOPO-X64-NEXT:    movq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    movq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    movq %rsi, (%rdi)
; TOPO-X64-NEXT:    movq %r8, 24(%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: add256:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add256_rmw:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    adcq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    adcq %r8, 24(%rdi)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add256_rmw2:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rdi, (%r8)
; TOPO-X64-NEXT:    adcq %rsi, 8(%r8)
; TOPO-X64-NEXT:    adcq %rdx, 16(%r8)
; TOPO-X64-NEXT:    adcq %rcx, 24(%r8)
; TOPO-X64-NEXT:    retq
;
...
; TOPO-X64-LABEL: a:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rcx, %rdx
; TOPO-X64-NEXT:    adcq $0, %r8
; TOPO-X64-NEXT:    movq %r8, (%rdi)
; TOPO-X64-NEXT:    movq %rdx, (%rsi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: a:
; X86:       # %bb.0: # %entry
...
; TOPO-X64-LABEL: b:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rdx, %rsi
; TOPO-X64-NEXT:    adcl $0, %ecx
; TOPO-X64-NEXT:    movl %ecx, (%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: b:
; X86:       # %bb.0: # %entry
...
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rdx, %rsi
; TOPO-X64-NEXT:    adcw $0, %cx
; TOPO-X64-NEXT:    movw %cx, (%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: c:
; X86:       # %bb.0: # %entry
...
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    addq %rdx, %rsi
; TOPO-X64-NEXT:    adcb $0, %cl
; TOPO-X64-NEXT:    movb %cl, (%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: d:
; X86:       # %bb.0: # %entry
...
; TOPO-X64-LABEL: e:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    # kill: def $esi killed $esi def $rsi
; TOPO-X64-NEXT:    movl (%rdi), %ecx
; TOPO-X64-NEXT:    leal (%rsi,%rcx), %edx
; TOPO-X64-NEXT:    addl %esi, %edx
; TOPO-X64-NEXT:    setb %al
; TOPO-X64-NEXT:    addl %ecx, %esi
; TOPO-X64-NEXT:    movl %edx, (%rdi)
; TOPO-X64-NEXT:    adcb $0, %al
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: e:
; X86:       # %bb.0:
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: pr31719:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq (%rsi), %rdx
; TOPO-X64-NEXT:    adcq 8(%rsi), %rcx
; TOPO-X64-NEXT:    adcq 16(%rsi), %r8
; TOPO-X64-NEXT:    adcq 24(%rsi), %r9
; TOPO-X64-NEXT:    movq %rdx, (%rdi)
; TOPO-X64-NEXT:    movq %rcx, 8(%rdi)
; TOPO-X64-NEXT:    movq %r8, 16(%rdi)
; TOPO-X64-NEXT:    movq %r9, 24(%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: pr31719:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: muladd:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdx, %rax
; TOPO-X64-NEXT:    mulq %rsi
; TOPO-X64-NEXT:    addq %rax, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    adcl $0, 16(%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: muladd:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: shiftadd:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdx, %rax
; TOPO-X64-NEXT:    addq %rsi, %rdi
; TOPO-X64-NEXT:    adcq %rcx, %rax
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: shiftadd:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry1_not:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    xorl %edx, %edx
; TOPO-X64-NEXT:    negq %rax
; TOPO-X64-NEXT:    sbbq %rsi, %rdx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: saddo_not_1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    xorl %edx, %edx
; TOPO-X64-NEXT:    negq %rax
; TOPO-X64-NEXT:    sbbq %rsi, %rdx
; TOPO-X64-NEXT:    seto %cl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: saddo_carry_not_1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    negq %rax
; TOPO-X64-NEXT:    movl $1, %edx
; TOPO-X64-NEXT:    sbbq %rsi, %rdx
; TOPO-X64-NEXT:    seto %cl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_to_subcarry:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rsi, %rcx
; TOPO-X64-NEXT:    notq %rcx
; TOPO-X64-NEXT:    xorl %edx, %edx
; TOPO-X64-NEXT:    addq %rdi, %rcx
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    xorl %eax, %eax
; TOPO-X64-NEXT:    cmpq %rsi, %rdi
; TOPO-X64-NEXT:    setae %al
; TOPO-X64-NEXT:    addq %rcx, %rax
; TOPO-X64-NEXT:    adcq $0, %rdx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_2x64:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    movq %rsi, %rdx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_hidden_2x64:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_hidden2_2x64:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_2x64_or_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_2x64_xor_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_2x64_and_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
; TOPO-X64-NEXT:    movq %rsi, %rdx
; TOPO-X64-NEXT:    xorl %ecx, %ecx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_2x64_add_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    adcq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_fake_carry:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    btl $0, %edx
; TOPO-X64-NEXT:    adcq %rsi, %rax
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_carry_not_zext:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rsi, %rax
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    orb %cl, %dl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_carry_not_i1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rsi, %rdi
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    movzbl %dl, %eax
; TOPO-X64-NEXT:    addq %rdi, %rax
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    orb %cl, %dl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_carry_and_1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    btl $0, %edx
; TOPO-X64-NEXT:    adcq %rsi, %rax
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_mixed_2x64:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %rcx, %rsi
; TOPO-X64-NEXT:    setb %dil
; TOPO-X64-NEXT:    addq %rdx, %rax
; TOPO-X64-NEXT:    sbbq $0, %rsi
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    orb %dil, %cl
; TOPO-X64-NEXT:    movq %rsi, %rdx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U320_without_i128_add:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    pushq %rbx
; TOPO-X64-NEXT:    movq 16(%rdi), %rax
; TOPO-X64-NEXT:    movq 24(%rdi), %r10
; TOPO-X64-NEXT:    movq 32(%rdi), %r11
; TOPO-X64-NEXT:    addq 8(%rdi), %rdx
; TOPO-X64-NEXT:    movq %rax, %rbx
; TOPO-X64-NEXT:    adcq %rcx, %rbx
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq $0, %rdx
; TOPO-X64-NEXT:    adcq $0, %rbx
; TOPO-X64-NEXT:    addq %rcx, %rax
; TOPO-X64-NEXT:    movq %r10, %rcx
; TOPO-X64-NEXT:    adcq %r8, %rcx
; TOPO-X64-NEXT:    cmpq %rax, %rbx
; TOPO-X64-NEXT:    adcq $0, %rcx
; TOPO-X64-NEXT:    leaq (%r11,%r9), %rsi
; TOPO-X64-NEXT:    addq %r8, %r10
; TOPO-X64-NEXT:    movq %r11, %r8
; TOPO-X64-NEXT:    adcq %r9, %r8
; TOPO-X64-NEXT:    cmpq %r10, %rcx
; TOPO-X64-NEXT:    adcq $0, %r8
; TOPO-X64-NEXT:    xorl %eax, %eax
; TOPO-X64-NEXT:    cmpq %rsi, %r8
; TOPO-X64-NEXT:    setb %al
; TOPO-X64-NEXT:    addq %r9, %r11
; TOPO-X64-NEXT:    movq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    movq %rbx, 16(%rdi)
; TOPO-X64-NEXT:    movq %rcx, 24(%rdi)
; TOPO-X64-NEXT:    movq %r8, 32(%rdi)
; TOPO-X64-NEXT:    adcl $0, %eax
; TOPO-X64-NEXT:    popq %rbx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U320_without_i128_or:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    adcq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    adcq %r8, 24(%rdi)
; TOPO-X64-NEXT:    adcq %r9, 32(%rdi)
; TOPO-X64-NEXT:    setb %al
; TOPO-X64-NEXT:    movzbl %al, %eax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U320_without_i128_xor:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    adcq %rcx, 16(%rdi)
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: bogus_add_U320_without_i128_and:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    addq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    addq %r8, 24(%rdi)
; TOPO-X64-NEXT:    addq %r9, 32(%rdi)
; TOPO-X64-NEXT:    xorl %eax, %eax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U320_without_i128_or_no_ret:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rsi, (%rdi)
; TOPO-X64-NEXT:    adcq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    adcq %rcx, 16(%rdi)
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: PR39464:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    movq (%rsi), %rcx
; TOPO-X64-NEXT:    addq (%rdx), %rcx
; TOPO-X64-NEXT:    movq %rcx, (%rdi)
; TOPO-X64-NEXT:    movq 8(%rsi), %rcx
; TOPO-X64-NEXT:    adcq 8(%rdx), %rcx
; TOPO-X64-NEXT:    movq %rcx, 8(%rdi)
; TOPO-X64-NEXT:    movq 16(%rsi), %rcx
; TOPO-X64-NEXT:    adcq 16(%rdx), %rcx
; TOPO-X64-NEXT:    movq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: PR39464:
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: uaddo_U128_without_i128_or:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    addq %rdx, %rdi
; TOPO-X64-NEXT:    adcq %rcx, %rsi
; TOPO-X64-NEXT:    setb %al
; TOPO-X64-NEXT:    movq %rsi, (%r8)
; TOPO-X64-NEXT:    movq %rdi, 8(%r8)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U192_without_i128_or:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    addq %r8, %rsi
; TOPO-X64-NEXT:    adcq %r9, %rdx
; TOPO-X64-NEXT:    adcq {{[0-9]+}}(%rsp), %rcx
; TOPO-X64-NEXT:    movq %rcx, (%rdi)
; TOPO-X64-NEXT:    movq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    movq %rsi, 16(%rdi)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U256_without_i128_or_by_i64_words:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    movq (%rdx), %rcx
; TOPO-X64-NEXT:    movq 8(%rdx), %rdi
; TOPO-X64-NEXT:    addq (%rsi), %rcx
; TOPO-X64-NEXT:    adcq 8(%rsi), %rdi
; TOPO-X64-NEXT:    movq 16(%rdx), %r8
; TOPO-X64-NEXT:    adcq 16(%rsi), %r8
; TOPO-X64-NEXT:    movq 24(%rdx), %rdx
; TOPO-X64-NEXT:    adcq 24(%rsi), %rdx
; TOPO-X64-NEXT:    movq %rdx, (%rax)
; TOPO-X64-NEXT:    movq %r8, 8(%rax)
; TOPO-X64-NEXT:    movq %rdi, 16(%rax)
; TOPO-X64-NEXT:    movq %rcx, 24(%rax)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: add_U256_without_i128_or_recursive:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    movq (%rdx), %rcx
; TOPO-X64-NEXT:    movq 8(%rdx), %rdi
; TOPO-X64-NEXT:    movq 16(%rdx), %r8
; TOPO-X64-NEXT:    movq 24(%rdx), %rdx
; TOPO-X64-NEXT:    addq 16(%rsi), %r8
; TOPO-X64-NEXT:    adcq 24(%rsi), %rdx
; TOPO-X64-NEXT:    addq (%rsi), %rcx
; TOPO-X64-NEXT:    adcq 8(%rsi), %rdi
; TOPO-X64-NEXT:    adcq $0, %r8
; TOPO-X64-NEXT:    adcq $0, %rdx
; TOPO-X64-NEXT:    movq %rcx, (%rax)
; TOPO-X64-NEXT:    movq %rdi, 8(%rax)
; TOPO-X64-NEXT:    movq %r8, 16(%rax)
; TOPO-X64-NEXT:    movq %rdx, 24(%rax)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_ult:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movl %edi, %eax
; TOPO-X64-NEXT:    cmpl %ecx, %edx
; TOPO-X64-NEXT:    adcl %esi, %eax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_ugt:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movl %edi, %eax
; TOPO-X64-NEXT:    cmpl %edx, %ecx
; TOPO-X64-NEXT:    adcl %esi, %eax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_ule:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    # kill: def $esi killed $esi def $rsi
; TOPO-X64-NEXT:    # kill: def $edi killed $edi def $rdi
; TOPO-X64-NEXT:    leal (%rdi,%rsi), %eax
; TOPO-X64-NEXT:    cmpl %edx, %ecx
; TOPO-X64-NEXT:    sbbl $-1, %eax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_commutative_1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rsi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rdi
; TOPO-X64-NEXT:    adcq %rcx, %rax
; TOPO-X64-NEXT:    movq %rax, %rdx
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: addcarry_commutative_2:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rsi, %rax
; TOPO-X64-NEXT:    addq %rdx, %rdi
; TOPO-X64-NEXT:    adcq %rcx, %rax
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: pr169691:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq (%rdi), %rax
; TOPO-X64-NEXT:    addq %rsi, %rax
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    movl %edx, %edx
; TOPO-X64-NEXT:    addq %rax, %rdx
; TOPO-X64-NEXT:    setb %al
; TOPO-X64-NEXT:    orb %cl, %al
; TOPO-X64-NEXT:    movq %rdx, (%rdi)
; TOPO-X64-NEXT:    addq 8(%rdi), %rsi
; TOPO-X64-NEXT:    movzbl %al, %eax
; TOPO-X64-NEXT:    addq %rsi, %rax
; TOPO-X64-NEXT:    movq %rax, 8(%rdi)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: pr169691:
; X86:       # %bb.0:
