...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: sub128:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: sub256:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %r9, %rsi
; TOPO-X64-NEXT:    sbbq {{[0-9]+}}(%rsp), %rdx
; TOPO-X64-NEXT:    sbbq {{[0-9]+}}(%rsp), %rcx
; TOPO-X64-NEXT:    sbbq {{[0-9]+}}(%rsp), %r8
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: negate:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    xorl %ecx, %ecx
; TOPO-X64-NEXT:    xorl %edx, %edx
; TOPO-X64-NEXT:    subq (%rsi), %rcx
; TOPO-X64-NEXT:    setae %dl
; TOPO-X64-NEXT:    movq 8(%rsi), %rdi
; TOPO-X64-NEXT:    movq 16(%rsi), %r8
; TOPO-X64-NEXT:    notq %rdi
; TOPO-X64-NEXT:    addq %rdx, %rdi
; TOPO-X64-NEXT:    notq %r8
; TOPO-X64-NEXT:    adcq $0, %r8
; TOPO-X64-NEXT:    movq 24(%rsi), %rdx
; TOPO-X64-NEXT:    notq %rdx
...
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    movq (%rsi), %rdi
; TOPO-X64-NEXT:    xorl %r10d, %r10d
; TOPO-X64-NEXT:    subq %rdx, %rdi
; TOPO-X64-NEXT:    setae %r10b
; TOPO-X64-NEXT:    xorl %edx, %edx
; TOPO-X64-NEXT:    addq 8(%rsi), %r10
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    notq %rcx
; TOPO-X64-NEXT:    addq %r10, %rcx
; TOPO-X64-NEXT:    adcq 16(%rsi), %rdx
; TOPO-X64-NEXT:    setb %r10b
; TOPO-X64-NEXT:    movzbl %r10b, %r10d
; TOPO-X64-NEXT:    notq %r8
; TOPO-X64-NEXT:    addq %rdx, %r8
; TOPO-X64-NEXT:    adcq 24(%rsi), %r10
; TOPO-X64-NEXT:    notq %r9
; TOPO-X64-NEXT:    addq %r10, %r9
; TOPO-X64-NEXT:    movq %rdi, (%rax)
; TOPO-X64-NEXT:    movq %rcx, 8(%rax)
; TOPO-X64-NEXT:    movq %r8, 16(%rax)
; TOPO-X64-NEXT:    movq %r9, 24(%rax)
; TOPO-X64-NEXT:    retq
;
; X86-LABEL: sub:
; X86:       # %bb.0: # %entry
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: sub_from_carry:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rcx, %rax
; TOPO-X64-NEXT:    negq %rax
; TOPO-X64-NEXT:    addq %rsi, %rdi
; TOPO-X64-NEXT:    movq %rdi, (%rdx)
; TOPO-X64-NEXT:    adcq $0, %rax
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_2x64_or_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_2x64_xor_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_2x64_and_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_2x64_add_reversed:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_fake_carry:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    btl $0, %edx
; TOPO-X64-NEXT:    sbbq %rsi, %rax
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_carry_not_zext:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rsi, %rax
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    setb %dl
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_carry_not_i1:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    subq %rsi, %rax
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    movzbl %dl, %edx
; TOPO-X64-NEXT:    subq %rdx, %rax
; TOPO-X64-NEXT:    setb %dl
; TOPO-X64-NEXT:    orb %cl, %dl
; TOPO-X64-NEXT:    retq
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: sub_U320_without_i128_or:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    subq %rsi, (%rdi)
; TOPO-X64-NEXT:    sbbq %rdx, 8(%rdi)
; TOPO-X64-NEXT:    sbbq %rcx, 16(%rdi)
; TOPO-X64-NEXT:    sbbq %r8, 24(%rdi)
; TOPO-X64-NEXT:    sbbq %r9, 32(%rdi)
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: sub_U256_without_i128_or_recursive:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    movq %rdi, %rax
; TOPO-X64-NEXT:    movq (%rsi), %rcx
; TOPO-X64-NEXT:    movq 8(%rsi), %rdi
; TOPO-X64-NEXT:    movq 16(%rsi), %r8
; TOPO-X64-NEXT:    movq 24(%rsi), %rsi
; TOPO-X64-NEXT:    subq 16(%rdx), %r8
; TOPO-X64-NEXT:    sbbq 24(%rdx), %rsi
; TOPO-X64-NEXT:    subq (%rdx), %rcx
; TOPO-X64-NEXT:    sbbq 8(%rdx), %rdi
; TOPO-X64-NEXT:    sbbq $0, %r8
; TOPO-X64-NEXT:    sbbq $0, %rsi
; TOPO-X64-NEXT:    movq %rcx, (%rax)
; TOPO-X64-NEXT:    movq %rdi, 8(%rax)
; TOPO-X64-NEXT:    movq %r8, 16(%rax)
; TOPO-X64-NEXT:    movq %rsi, 24(%rax)
; TOPO-X64-NEXT:    retq
;
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_ult_2x64:
; TOPO-X64:       # %bb.0:
; TOPO-X64-NEXT:    subq %rcx, %rsi
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    cmpq %rdx, %rdi
; TOPO-X64-NEXT:    sbbq $0, %rsi
; TOPO-X64-NEXT:    setb %al
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_ult_2x64_2:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    cmpq %rdx, %rdi
; TOPO-X64-NEXT:    sbbq %rcx, %rsi
; TOPO-X64-NEXT:    setb %al
...
; X64-NEXT:    retq
;
; TOPO-X64-LABEL: subcarry_ult_2x64_1x64:
; TOPO-X64:       # %bb.0: # %entry
; TOPO-X64-NEXT:    cmpq %rdx, %rdi
; TOPO-X64-NEXT:    setb %cl
; TOPO-X64-NEXT:    testq %rsi, %rsi
; TOPO-X64-NEXT:    sete %al
; TOPO-X64-NEXT:    andb %cl, %al
; TOPO-X64-NEXT:    retq
;
